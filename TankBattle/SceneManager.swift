...
final class SceneManager {
    ...
    */
    ...
    //marked by sunnry private var progressScene: ProgressScene?
    ...
    func presentSceneForSceneLoader(sceneLoader: SceneLoader) {
        ...
        dispatch_async(dispatch_get_main_queue()) {
            ...
            */
            ...
            let transition = SKTransition.fadeWithDuration(GameConfiguration.SceneManager.transitionDuration)
            ...
            */
            ...
            //marked by sunnry self.progressScene = nil
 ...
 */
    ...
    func sceneLoaderForSceneIdentifier(sceneIdentifier: SceneIdentifier) -> SceneLoader {
        ...
        case .Level(let number):
            sceneMetadata = sceneConfigurationInfo[number+1]
